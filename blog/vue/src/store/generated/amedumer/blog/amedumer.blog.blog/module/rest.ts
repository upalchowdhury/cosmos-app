...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/amedumer/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/amedumer/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/amedumer/blog/blog/comments/{id}
   */
  queryComments = (
    id: string,
    query?: {
    ...
    this.request<BlogQueryCommentsResponse, RpcStatus>({
      path: `/amedumer/blog/blog/comments/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
